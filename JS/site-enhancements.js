...
// Quick links section for the header
function initQuickLinks() {
    ...
    if (header) {
        ...
        // Define quick links
        const links = [
            { text: 'Cookies', url: 'Recipes.html#cookies' },
            { text: 'Brownies', url: 'chocolatebrownies.html' },
            { text: 'Seasonal', url: 'Recipes.html#seasonal' }
        ];
        ...
        // Add to header as the first child
        // The grid-template-areas will place it in the "left" area
        if (header.firstChild) {
            header.insertBefore(quickLinks, header.firstChild);
        } else {
            header.appendChild(quickLinks);
        }
    }
}
...
function initSearchFunctionality() {
    ...
    if (header) {
        ...
        // Append the search container to the end of the header
        // The grid-template-areas will place it in the "search" area
